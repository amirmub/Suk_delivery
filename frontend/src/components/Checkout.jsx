      ...
      <div className={checkoutStyles.container}>
                ...
                <label className={checkoutStyles.radioCard}>
                  ...
                  <div className="ml-3">
                    <span className="font-medium text-emerald-100">
                     ...
                     Coming soon. For now, pay via Telebirr: 0979552308
                   </span>
                  </div>
                </label>
              </div>
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <span className="text-emerald-400">
                          Birr{item.price.toFixed(2)} × {item.quantity}
                        </span>
                        <span className="font-medium text-emerald-100">
        ...
        <div className={checkoutStyles.deliveryInfo}>
          ...
          <p className={checkoutStyles.deliveryText}>
            We deliver within 30-45 minutes. Orders placed after 00:00 PM will be
