                    ...
                    <div className="border border-emerald-700 rounded-xl overflow-hidden">
                      {selectedOrder.items.map((item, index) => (
                        ...
                        >
                          ...
                          <div className="flex-grow">
                            ...
                            <div className="text-emerald-400">Birr{item.price.toFixed(2)} × {item.quantity}</div>
                          </div>
                      ...
                      <div className="p-4 bg-emerald-800/50">
                        <div className="flex justify-between py-2">
                          ...
                          <span className="font-medium text-emerald-100">Birr{selectedOrder.total.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between py-2">
                        ...
                        <div className="flex justify-between py-2">
                          ...
                          <span className="font-medium text-emerald-100">Birr{(selectedOrder.total * 0.05).toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between pt-4 mt-2 border-t border-emerald-700">
                          ...
                          <span className="text-lg font-bold text-emerald-300">
                            Birr{(selectedOrder.total * 1.05).toFixed(2)}
                          </span>
                        </div>
                      </div>
                    </div>
