                    ...
                    <div className={styles.modalOrderSummary}>
                      {selectedOrder.items.map((item, index) => (
                        ...
                        >
                          ...
                          <div className="flex-grow">
                            ...
                            <div className="text-gray-600">Birr{item.price.toFixed(2)} × {item.quantity}</div>
                          </div>
                      ...
                      <div className={styles.modalOrderTotalSection}>
                        <div className={styles.modalOrderTotalRow}>
                          ...
                          <span className="font-medium">Birr{selectedOrder.total.toFixed(2)}</span>
                        </div>
                        <div className={styles.modalOrderTotalRow}>
                        ...
                        <div className={styles.modalOrderTotalRow}>
                          ...
                          <span className="font-medium">Birr{(selectedOrder.total * 0.05).toFixed(2)}</span>
                        </div>
